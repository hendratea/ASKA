...
<style>
    body {
        ...
        font-weight: <weight>;
        font-style: normal;
        background-image: url(assets/picture_profiles/logo3.jpg);
...
<body class="theme-blush">
    ...
    <script src="<?= base_url() ?>assets/template/bundles/vendorscripts.bundle.js"></script> <!-- Lib Scripts Plugin Js -->     
