                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="input-group masked-input">
                                    ...
                                    <input id="idGolongan" name="idGolongan" type="text" class="form-control" >
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="input-group masked-input mb-3">
                                    ...
                                    <div id="msgErrStatus" class="col-sm-12" style="font-size: 11px;font-style: italic;padding:0px;text-align:right;color:red"></div>
                                </div>
                            </div>                           
                            <div class="col-lg-4 col-md-6">
                                <label>APTLN</label>
                                <div class="input-group masked-input mb-3">
                                    ...
                                    <div id="msgErrAptln" class="col-sm-12" style="font-size: 11px;font-style: italic;padding:0px;text-align:right;color:red"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-6">
                                <div class="table-responsive" style="font-size: 12px;font-family:Arial, Helvetica, sans-serif;width:100%">
                                    <table class="table table-bordered table-striped table-hover nowrap"
                                        id="dt_golongan" width="100%">
                                        <thead>
                                        <tr>
                                            <th width="3%" style="text-align: center;vertical-align : middle;">ID</th>
                                            <th width="20%" style="text-align: center;vertical-align : middle;">Status</th>
                                            <th width="25%" style="text-align: center;vertical-align : middle;">APTLN</th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button onclick="save_data_golongan()" id="btnSubmitDataPegawai" type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-check" aria-hidden="true"></i> YES</button>
      </div>
    </div>
  </div>
</div>
