          ...
          <div class="body">
            <div class="row clearfix">
              ...
              <div class="col-lg-4 col-md-6">
                <label>Jatah</label>
                <div class="input-group masked-input mb-3">
                  <div id="boxIconJatah" class="input-group-prepend">
                    <span class="input-group-text"><i class="zmdi zmdi-card"></i></span>
                  </div>
                  <input id="jatah" name="jatah" type="text" class="form-control">
                  <div id="msgErrJatah" class="col-sm-12"
                    style="font-size: 11px;font-style: italic;padding:0px;text-align:right;color:red"></div>
                </div>
              </div>
              ...
              <div class="col-lg-12 col-md-6">
                <div class="table-responsive"
                  ...
                  <table class="table table-bordered table-striped table-hover nowrap" id="dt_referensi_cuti"
                    width="100%">
                    <thead>
                      <tr>
                        ...
                        <th width="25%" style="text-align: left;vertical-align : middle;">Jatah</th>
