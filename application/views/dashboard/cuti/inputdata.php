          ...
          <div class="body">
            <div class="row clearfix">
              ...
              <div class="col-lg-6 col-md-6">
                ...
                <div class="input-group masked-input mb-3">
                  <div id="boxIconLamaCuti" class="input-group-prepend">
                    <span class="input-group-text"><i class="zmdi zmdi-card"></i></span>
                  </div>
                  <input id="lamaCuti" name="lamaCuti" type="text" class="form-control" value="1 hari">
                  <div id="msgErrlamaCuti" class="col-sm-12"
                    style="font-size: 11px;font-style: italic;padding:0px;text-align:right;color:red"></div>
                </div>
              </div>
              <div class="col-lg-6 col-md-6">
              ...
              <div class="col-lg-6 col-md-6">
                ...
                <div class="input-group masked-input mb-3">
                  <div id="boxJenisCuti" class="input-group-prepend">
                    <span class="input-group-text"><i class="zmdi zmdi-card"></i></span>
                  </div>
                  <select id="jenisCuti" name="jenisCuti" class="form-control show-tick ms select2"
                    data-placeholder="--Pilih--">
                    <!-- <option value="0" selected hidden>--Pilih--</option> -->
                    <option value=""></option>
                    <?php
                    foreach ($listRefCuti as $list) { ?>
                      <option value="<?= $list->ID ?>"><?= $list->status ?></option>
                    <?php } ?>
                  </select>
                  <div id="msgErrjenisCuti" class="col-sm-12"
                    style="font-size: 11px;font-style: italic;padding:0px;text-align:right;color:red"></div>
                </div>
              </div>
              <div class="col-lg-6 col-md-6">
              ...
              <div class="col-lg-12 col-md-6">
                <div class="table-responsive"
                  ...
                  <table class="table table-bordered table-striped table-hover nowrap" id="dt_cuti_inputdata"
                    width="100%">
                    <thead>
                      <tr>
                        ...
                        <th width="07%" style="text-align: left;vertical-align : middle;">Jenis Cuti</th>
                        <th width="10%" style="text-align: left;vertical-align : middle;">Tgl Pengajuan</th>
                        <th width="10%" style="text-align: left;vertical-align : middle;">Tgl Awal Cuti</th>
                        <th width="10%" style="text-align: left;vertical-align : middle;">Tgl Akhir Cuti</th>
                        <th width="10%" style="text-align: left;vertical-align : middle;">Lama Cuti</th>
