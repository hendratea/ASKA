                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <a href="profile.html">
                                        <img id="modify_img" src="<?= base_url() ?>assets/picture_profiles/default_avatar.png" class="rounded-circle shadow " alt="profile-image" height="100" width="100">
                                    </a>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="input-group masked-input">
                                    ...
                                    <div id="msgErrIdPegawai" class="col-sm-12" style="font-size: 11px;font-style: italic;padding:0px;text-align:right;color:red"></div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="input-group masked-input mb-3">
                                    ...
                                    <div id="msgErrNamaPegawai" class="col-sm-12" style="font-size: 11px;font-style: italic;padding:0px;text-align:right;color:red"></div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="form-group-append">
                                    <div class="radio inlineblock">
                                        <input type="radio" name="jenisKelamin" id="laki-laki" class="with-gap" value="Laki-laki" tabindex="2">
                                        <label for="laki-laki">Laki-Laki</label>
                                    </div>
                                    <div class="radio inlineblock m-r-20">
                                        <input type="radio" name="jenisKelamin" id="perempuan" class="with-gap" value="Perempuan" tabindex="3">
                                        <label for="perempuan">Perempuan</label>
                                    </div>
                                </div>
                                <div id="msgErrJenisKelamin" class="col-sm-12" style="font-size: 11px;font-style: italic;padding:0px;text-align:left;color:red"></div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="input-group masked-input mb-3">
                                    ...
                                    <div id="msgErrTempatLahir" class="col-sm-12" style="font-size: 11px;font-style: italic;padding:0px;text-align:right;color:red"></div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control tanggalLahirPicker" name="tanggalLahir" id="tanggalLahir" onkeydown="return false">
                                    <div id="msgErrTanggalLahir" class="col-sm-12" style="font-size: 11px;font-style: italic;padding:0px;text-align:right;color:red"></div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <label>Telepon</label>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="input-group masked-input mb-3">
                                    ...
                                    <select id="statusKerja" class="form-control show-tick ms select2" data-placeholder="Select" name="statusKerja">
                                        <option value=""></option>
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <div class="form-group-append">
                                    <div id="showDetailPns" class="radio inlineblock m-r-20" data-toggle="collapse" data-target="#collapsePns" >
                                        <input type="radio" name="statusKaryawan" id="pns" class="with-gap" value="PNS" tabindex="2">
                                        <label for="pns">PNS</label>
                                    </div>
                                    <div id="showDetailNonPns" class="radio inlineblock" data-toggle="collapse" data-target="#collapseNonPns">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-3 col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control tanggalLahirPicker" name="tglTerimaJabatan" id="tglTerimaJabatan" onkeydown="return false">
                                                ...
                                                <div class="col-lg-3 col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control tanggalLahirPicker" name="tglDiplomatik" id="tglDiplomatik" onkeydown="return false">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-3 col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control tanggalLahirPicker" name="tglMasukKerja" id="tglMasukKerja" onkeydown="return false">
                                                ...
                                                <div class="col-lg-3 col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control tanggalLahirPicker" name="awalKontrak" id="awalKontrak" onkeydown="return false">
                                                ...
                                                <div class="col-lg-3 col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control tanggalLahirPicker" name="akhirKontrak" id="akhirKontrak" onkeydown="return false">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button onclick="save_data_pegawai()" id="btnSubmitDataPegawai" type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-check" aria-hidden="true"></i> YES</button>
      </div>
    </div>
  </div>
</div>