            ...
            <div class="row clearfix">
              ...
              <div class="col-lg-4 col-md-6">
                ...
                <div class="input-group masked-input">
                  ...
                  <div id="msgErrUserId" class="col-sm-12"
              ...
              <div class="col-lg-4 col-md-6">
                ...
                <div class="input-group masked-input mb-3">
                  ...
                  <div id="msgErrPassword" class="col-sm-12"
                    style="font-size: 11px;font-style: italic;padding:0px;text-align:right;color:red"></div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                ...
                <div class="input-group masked-input mb-3">
                  ...
                  <div id="msgErrEmail" class="col-sm-12"
                    style="font-size: 11px;font-style: italic;padding:0px;text-align:right;color:red"></div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                ...
                <div class="input-group masked-input mb-3">
                  ...
                  <select id="roleUser" class="form-control show-tick ms select2" data-placeholder="Select"
                    name="roleUser">
                  ...
                  <div id="msgErrRoleUser" class="col-sm-12"
                    style="font-size: 11px;font-style: italic;padding:0px;text-align:right;color:red"></div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                ...
                <div class="input-group masked-input mb-3">
                  ...
                  <select id="idPegawai" class="form-control show-tick ms select2" data-placeholder="Select"
                    name="idPegawai">
                    <option value="-"></option>
                    <!-- <option value="-"></option> -->
                    <?php
              ...
              <div class="col-lg-4 col-md-6">
                ...
                <div id="msgErrStatusAktif" class="col-sm-12"
              ...
              <div class="col-lg-12 col-md-6">
                <div class="table-responsive"
                  ...
                  <table class="table table-bordered table-striped table-hover nowrap" id="dt_setting_user"
                    width="100%">
                    <thead>
                      <tr>
                        <th width="03%" style="text-align: center;vertical-align : middle;">User</th>
                        <th width="20%" style="text-align: center;vertical-align : middle;">Email</th>
                        <th width="25%" style="text-align: center;vertical-align : middle;">Aktif</th>
                        ...
                        <th width="25%" style="text-align: center;vertical-align : middle;">Tindakan</th>
                      </tr>
                    </thead>
                    <tbody>
                    </tbody>
