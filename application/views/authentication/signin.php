...
<div class="header"><a href="<?= base_url() ?>copyright">
    <img class="logo" src="<?= base_url() ?>assets/template/images/KJRI.png" alt="">
    <!-- <h5><?= $h5_title; ?></h5> -->

    <h6 class="text-center text-primary pulse animated infinite"
      style="text-shadow: 6px 3px #434a52;text-align: center;font-size: 64px;font-weight: bold;text-decoration: underline;">
      ASKA</h6>
    <h6 class="text-center" data-bss-hover-animate="swing"
      style="text-shadow: 2px 1px #214a80;font-size: large;font-weight: bold;color: rgb(131,139,209);">Administrasi
      Kepegawaian</h6>
  </a></div>
...
<div class="body">
  ...
  <a href="javascript: $('#submit_login_temp').val('posting'); $('#myform').submit();"
    ...
    style="text-shadow: 2px 1px #214a80;font-size: large;font-weight: bold;">MASUK</a>

  <div class="row px-3 mb-4">
    <a href="<?= base_url(); ?>forgot_password" class="ml-auto mb-0 text-sm" data-bss-hover-animate="shake">Lupa
      Password?</a>
  </div>
</div>
</form>